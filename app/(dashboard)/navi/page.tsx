...
// Client Supabase inline per evitare di caricare supabaseAdmin lato browser
// (lib/supabase-client.ts ha side effects al top-level che crashano lato client)
...
export default function NaviPage() {
  ...
  async function loadArrivi() {
    try {
      ...
      if (vista === 'stagione') {
        // Fetch tutto l'anno per la vista stagionale
        query = query
          .gte('data_arrivo', `${annoStagione}-01-01`)
          .lte('data_arrivo', `${annoStagione}-12-31`)
      } else {
        // Fetch solo il mese per le viste operative
  ...
  // Stats (solo per viste lista/tabella, mensili)
  ...
  return (
    <div className="p-4 md:p-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
        ...
        {/* Navigatore mese (solo per viste lista/tabella) */}
        {!isStagione && (
        ...
        {/* Selettore anno (solo per vista stagione) */}
        {isStagione && (
          <div className="flex items-center gap-2">
      ...
      {/* KPI mensili (nascoste in vista stagione perché VistaStagione ha le sue) */}
      {!isStagione && (
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 mb-4">
        ...
        {/* Legenda taglie (solo per viste operative, da desktop in su) */}
        {!isStagione && (
