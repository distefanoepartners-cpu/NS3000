...
export default function VistaStagione({ arrivi }: { arrivi: Arrivo[] }) {
  const stats = useMemo(() => {
    ...
    const totalePax = arrivi.reduce((s, a) => s + (a.capienza_pax || 0), 0)
    ...
    arrivi.forEach((a) => {
      ...
      byMonth[month] = (byMonth[month] || 0) + a.capienza_pax
      byMarket[market] = (byMarket[market] || 0) + a.capienza_pax
      if (!byCompany[company]) byCompany[company] = { pax: 0, arrivi: 0, market }
      byCompany[company].pax += a.capienza_pax
      byCompany[company].arrivi += 1
      if (!byDay[a.data_arrivo]) byDay[a.data_arrivo] = { pax: 0, navi: [] }
      byDay[a.data_arrivo].pax += a.capienza_pax
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl p-5 border border-gray-100 shadow-sm">
        <div className="flex items-center justify-between mb-4">
          ...
          <span className="text-xs text-gray-500">Capienza passeggeri totale per mese</span>
        </div>
        <ResponsiveContainer width="100%" height={240}>
          <BarChart data={stats.monthData} margin={{ top: 10, right: 10, bottom: 0, left: 0 }}>
            ...
            <Tooltip
              ...
              formatter={(v: number) => [v.toLocaleString('it-IT') + ' pax', 'Capienza']}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
        ...
        <div className="bg-white rounded-xl p-5 border border-gray-100 shadow-sm lg:col-span-3">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-xs text-gray-500">Per capienza passeggeri</span>
          </div>
      ...
      <div className="bg-white rounded-xl p-5 border border-gray-100 shadow-sm">
        <div className="flex items-center justify-between mb-4">
          ...
          <span className="text-xs text-gray-500">Heatmap giornaliera capienza passeggeri</span>
        </div>
            ...
            <table className="w-full">
              <thead className="bg-gray-50 border-b border-gray-200">
                <tr>
                  ...
                  <th className="px-4 py-2.5 text-right text-[10px] font-semibold text-gray-500 uppercase tracking-wider">Capienza</th>
